...
def checkIn_after_checkOut():
    try:
        ...
        error_message_elements = driver.find_elements(By.XPATH, "//div[@class='alert alert-danger']")

        assert error_message_elements
        print("Test checkIn after checkOut succeeded")
    except Exception as e:
        print("Test checkIn after checkOut failed:", str(e))
